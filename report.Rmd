...
First was applied a principal component analysis in order to capture at least 80% variance and this number is reached with 82 components. Then was applied a tSNE algorithm, was estimated that the number of steps that minimize the K-L divergence is 1250. So was tried perplexity between 1 up to 58 and the perplexity that make the cluster more visible is 2.
